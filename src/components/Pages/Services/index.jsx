                    ...
                    <div className="container">
                        ...
                        <div className="btn_group">
                            ...
                            <div className='btn_group_child'>
                                <button onClick={() => router.push('/order-project')}>Пора заказать</button>
                                <button onClick={() => router.push('/order-project')}>проект</button>
                                <button onClick={() => router.push('/order-project')}>от Getter</button>
                            </div>
                        </div>
